...
export class ImageSetsSenecaPlugin extends SenecaPlugin {
    ...
    private static createReferences(seneca: any, options: any): References {
        ...
        if (persistenceType == 'mongodb') 
            ...
            persistence = new ImageSetsFilePersistence();
        ...
        let service = new ImageSetsSenecaServiceV1();
        ...
        return References.fromTuples(
            ...
            new Descriptor('pip-services-imagesets', 'persistence', persistenceType, 'default', '1.0'), persistence,
