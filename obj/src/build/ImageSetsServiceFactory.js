...
class ImageSetsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
ImageSetsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "factory", "default", "default", "1.0");
ImageSetsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "persistence", "memory", "*", "1.0");
ImageSetsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "persistence", "file", "*", "1.0");
ImageSetsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "persistence", "mongodb", "*", "1.0");
ImageSetsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "controller", "default", "*", "1.0");
ImageSetsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "service", "seneca", "*", "1.0");
ImageSetsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-imagesets", "service", "http", "*", "1.0");
