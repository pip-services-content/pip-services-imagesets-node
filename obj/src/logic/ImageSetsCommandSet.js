...
class ImageSetsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetImageSetsCommand() {
        return new pip_services3_commons_node_2.Command("get_imagesets", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetImageSetByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_imageset_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('imageset_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateImageSetCommand() {
        return new pip_services3_commons_node_2.Command("create_imageset", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateImageSetCommand() {
        return new pip_services3_commons_node_2.Command("update_imageset", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('imageset', new ImageSetV1Schema_1.ImageSetV1Schema()), (correlationId, args, callback) => {
            let imageset = args.get("imageset");
    ...
    makeDeleteImageSetByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_imageset_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('imageset_id', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let imagesetId = args.getAsNullableString("imageset_id");
