...
The ImageSets microservice can also be used as a Seneca plugin.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-imagesets-node": "^1.0.*",
        ...
    }
}
```
...
var plugin = require('pip-services-imagesets-node').ImageSetsSenecaPlugin;
...
or by using [ImageSetsSenecaClient](https://github.com/pip-services-content/pip-clients-imagesets-node/NodeClientApiV1.md/#client_seneca)